...
- v0.3 (2025-11): UI & Statistics Update / 界面与统计更新
  ...
  - Integrated Help link / 集成帮助链接
- v0.2 (2025-11): Feature Update / 功能更新
  - Improved filtering logic / 改进的筛选逻辑
  - Deduplicate-aware statistics / 支持去重的统计
  - Bug fixes / 错误修复
